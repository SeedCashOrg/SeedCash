    ...
    def __init__(self, display_type: str = DISPLAY_TYPE__ST7789, width: int = None, height: int = None):
        ...
        if self.display_type == DISPLAY_TYPE__ST7789:
            ...
            if width == 240:
                ...
                from seedcash.hardware.displays.ST7789 import ST7789
                self.display = ST7789()

            elif width == 320:
                from seedcash.hardware.displays.st7789_mpy import ST7789
            ...
            from seedcash.hardware.displays.ili9341 import ILI9341
